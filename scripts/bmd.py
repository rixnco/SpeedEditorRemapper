...
class SpeedEditor:
	...
	def authenticate(self):
		...
		data = self.dev.get_feature_report(1, 8)
		print(data)

		data = self.dev.get_feature_report(8, 33)
		print(data)

		# self.dev.write(b'\x03\x02\x00\x00\x00\x00\xFF')
		# self.dev.write(b'\x04\x01')
		# self.dev.write(b'\x02\x20\x00\x00\x00')
